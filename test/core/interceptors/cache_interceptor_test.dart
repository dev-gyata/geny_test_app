  ...
  group('Cache interceptor ...', () {
    test(
      ...
      () async {
        ...
        await cacheInterceptor.addToCache(CacheEntry(mockResponse));
    ...
    test(
      'Should Return the response from the cache if onError is called',
      () async {
        // arrange
        final mockRequestOptions = RequestOptions(
          path: '/businesses',
        ...
        await cacheInterceptor.onError(
          DioException(
            requestOptions: mockRequestOptions,
          ),
          mockErrorHandler,
        ...
        verifyNever(
          mockErrorHandler.next(
            DioException(requestOptions: mockRequestOptions),
          ),
        );
      },
    );
